...
*InferenceServiceApi* | [**get_inference_service_status**](docs/InferenceServiceApi.md#get_inference_service_status) | **GET** /apis/v1beta1/{namespace}/inferenceservice/{name} | 
