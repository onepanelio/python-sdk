...
from onepanel.core.api.models.list_workflow_executions_response import ListWorkflowExecutionsResponse  # noqa: E501
...
class TestListWorkflowExecutionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = onepanel.core.api.models.list_workflow_executions_response.ListWorkflowExecutionsResponse()  # noqa: E501
        if include_optional :
            return ListWorkflowExecutionsResponse(
                count = 56, 
                workflow_executions = [
                    onepanel.core.api.models.workflow_execution.WorkflowExecution(
                        created_at = '0', 
                        uid = '0', 
                        name = '0', 
                        phase = '0', 
