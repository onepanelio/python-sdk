...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of core.api.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the core.api.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = core.api.Configuration(
        signing_info = core.api.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost:8887",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("core.api")
