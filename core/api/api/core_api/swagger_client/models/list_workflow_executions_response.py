...
class ListWorkflowExecutionsResponse(object):
    ...
    def __init__(self, count=None, workflow_executions=None, page=None, pages=None, total_count=None):  # noqa: E501
        """ListWorkflowExecutionsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListWorkflowExecutionsResponse, dict):
