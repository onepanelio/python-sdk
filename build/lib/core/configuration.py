...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of core.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the core.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = core.Configuration(
        signing_info = core.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
