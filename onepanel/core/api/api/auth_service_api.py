...
class AuthServiceApi(object):
    ...
    def is_authorized_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IsAuthorizedResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def is_valid_token_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IsValidTokenResponse, status_code(int), headers(HTTPHeaderDict))
        """
