...
class CreateWorkspaceBody(object):
    ...
    def __init__(self, workspace_template_uid=None, workspace_template_version=None, parameters=None, labels=None, capture_node=None, local_vars_configuration=None):  # noqa: E501
    ...
    def capture_node(self):
        """Gets the capture_node of this CreateWorkspaceBody.  # noqa: E501


        :return: The capture_node of this CreateWorkspaceBody.  # noqa: E501
        :rtype: bool
        """
        return self._capture_node

    @capture_node.setter
    def capture_node(self, capture_node):
        """Sets the capture_node of this CreateWorkspaceBody.


        :param capture_node: The capture_node of this CreateWorkspaceBody.  # noqa: E501
        :type: bool
        """

        self._capture_node = capture_node
